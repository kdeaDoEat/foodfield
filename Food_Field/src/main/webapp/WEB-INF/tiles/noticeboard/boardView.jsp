		...
		<div class="navbar-form navbar">
			...
			<c:forEach var="reply" items="${comments}" varStatus="status">
                  <tr>                 
                    ...
                    <span id="replycontents${status.index}" class="replycontents" style="margin-left:20px;">${reply.contents}</span>
                    <span id="replywdate${status.index}" style="margin-left:20px;">${reply.w_date}</span>
                    ...
                    <span id="replynick">${reply.nickname}</span> <span id="freplycontents${status.index}" style="margin-left:20px;"><input type="text" name="contents" value="${reply.contents}"></span> <span id="replywdate" style="margin-left:20px;">${reply.w_date}</span>
                    <span style="float:right">
