                ...
                <article class="post">
                    ...
                    <div class="share-container">
                        ...
                        <ul class="rrssb-buttons clearfix rrssb-1">
                            <li class="rrssb-facebook" data-initwidth="14.285714285714286" data-size="64" style="width: calc(100% - 252px);">
                            ...
                            <li class="rrssb-twitter small" data-initwidth="14.285714285714286" data-size="50" style="width: 42px;">
                            ...
                            <li class="rrssb-reddit small" data-initwidth="14.285714285714286" data-size="42" style="width: 42px;">
                            ...
                            <li class="rrssb-googleplus small" data-initwidth="14.285714285714286" data-size="57" style="width: 42px;">
                                <!-- Replace href with your meta and URL information.  -->
                            ...
                            <li class="rrssb-linkedin small" data-initwidth="14.285714285714286" data-size="53" style="width: 42px;">
                                <!-- Replace href with your meta and URL information -->
                            ...
                            <li class="rrssb-pocket small" data-initwidth="14.285714285714286" data-size="47" style="width: 42px;">
                            ...
                            <li class="rrssb-github small" data-initwidth="14.285714285714286" data-size="44" style="width: 42px;">
    				...
    				<div id="comment-area" class="comment-area">
    				    <div class="comment-container">        				    
        				    <div class="comment-list">
            				    ...
            				    <div class="comment-item depth-1 parent">
                				    <div class="comment-item-box">
                    				    <div class="comment-author">
                        				    <img class="img-responsive" src="assets/images/comment/user-1.jpg" alt="">
                    				    </div><!--//comment-author-->
                				    ...
                				    <div class="children">
                    				    <div class="comment-item depth-2 child">
                        				    <div class="comment-item-box">
                            				    <div class="comment-author">
                                				    <img class="img-responsive" src="assets/images/comment/user-2.jpg" alt="">
                            				    </div><!--//comment-author-->
                            				    <div class="comment-body">
            				    ...
            				    <div class="comment-item depth-1 parent">
                				    <div class="comment-item-box">
                    				    <div class="comment-author">
                        				    <img class="img-responsive" src="assets/images/comment/user-4.jpg" alt="">
                    				    </div><!--//comment-author-->
                    				    <div class="comment-body">
    				    ...
    				    <div class="comment-form-container">
        				    ...
        				    <form id="comment-form" class="comment-form form" method="post" action="#" novalidate="novalidate">                   
                                <div class="row">                                                                                                                                                                     
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
                                        ...
                                        <textarea class="form-control" id="ccomment" name="comment" placeholder="Leave your comment" rows="12" required="" aria-required="true"></textarea>
                                    </div>
                                    <div class="col-md-12 col-sm-12 col-xs-12 form-group">
