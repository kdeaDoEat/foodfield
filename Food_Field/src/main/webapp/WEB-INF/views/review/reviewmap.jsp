    ...
    <div id="menu_wrap" class="bg_white">
        <div class="option">
            <p>
                ...
                키워드 : <input type="text" value="${type}" id="keyword" size="15"> 
...
function getListItem(index, places) {
	var name = "'"+places.title+"'";
	var add = "'"+places.newAddress+"'";
	
    var el = document.createElement('li'),
    itemStr = '<span class="markerbg marker_' + (index+1) + '"></span>' +
                '<div class="info" onclick="commit('+name+','+add+')">' +
                '   <h5>' + places.title + '</h5>';
...
function commit(name,add) {
	window.opener.document.inputForm.shop_name.value=name;
	window.opener.document.inputForm.shop_add.value=add;
	window.close();
}
</script>
</body>
