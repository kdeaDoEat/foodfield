...
function search() {
	...
	if($('#search_concept').text() == 'Option'){
		...
		else if($('#search_concept').text() == '받는사람')	text='receiver';
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu" style="text-align: center;">
                    ...
                    <li>
                      ...
                      <li>
                        <a  href="sendBox?page=1"><i class="fa fa-folder-open-o" aria-hidden="true"></i> 보낸 쪽지함</a>
                    </li>
                </ul>
			</div>
        </nav>  
	                                ...
	                                <table class="table">
	                                    <thead>
	                                        <tr>
	                                            ...
	                                            <th style="width: 20%; text-align: center;">받는사람</th>
												...
												<div class="input-group">
													<div class="input-group-btn search-panel">
									                    ...
									                    <ul class="dropdown-menu" role="menu">
									                      ...
									                      <li><span style="cursor: pointer;" onclick="search_Option('받는사람');">받는사람</span></li>
									                    </ul>
								                    </div>
